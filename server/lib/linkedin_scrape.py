...
async def scrape_linkedin(url: str) -> dict:
    # Validate URL — prevent injection via execFileSync argument
    if not url.startswith(('https://www.linkedin.com/', 'https://linkedin.com/', 'https://www.linkedin.')):
        return {"ok": False, "error": f"Invalid LinkedIn URL: {url[:80]}"}
